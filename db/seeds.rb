...
transaction3 = Transaction.create(goal: goal1, wallet: wallet1, category: category1, title: 'Plane Ticket', description: 'Flights on the biggest plane', amount: 1235, date: Date.new(2024, 5, 10), transaction_type: 1)
transaction4 = Transaction.create(goal: goal2, wallet: wallet0, category: category3, title: 'Freelance Work', description: 'Customer is happy, I have my money paid', amount: 450, date: Date.new(2024, 1, 9), transaction_type: 0)
transaction5 = Transaction.create(goal: goal1, wallet: wallet1, category: category1, title: 'Birthday Gift', description: 'I got a birthday gifts', amount: 654, date: Date.new(2024, 2, 07), transaction_type: 0)
transaction6 = Transaction.create(goal: goal2, wallet: wallet0, category: category3, title: 'Villa House', description: 'Bought new Villa house online', amount: 54235, date: Date.new(2025, 4, 17), transaction_type: 1)
transaction7 = Transaction.create(goal: goal1, wallet: wallet1, category: category1, title: 'Trip To Dubai', description: 'Travel to Dubai with friends', amount: 20, date: Date.new(2026, 6, 10), transaction_type: 1)
...
transaction1 = Transaction.create(goal: goal1, wallet: wallet1, category: category1, title: 'Movie Tickets', description: 'Watched a movie with friends', amount: 6243, date: Date.new(2025, 05, 10), transaction_type: 1)
transaction2 = Transaction.create(goal: goal2, wallet: wallet0, category: category3, title: 'Gaming Console', description: 'Got a new gaming console', amount: 8735, date: Date.new(2025, 4, 27), transaction_type: 0)
transaction3 = Transaction.create(goal: goal1, wallet: wallet1, category: category1, title: 'Dinner', description: 'Had dinner with family', amount: 1535, date: Date.new(2024, 01, 10), transaction_type: 1)
transaction4 = Transaction.create(goal: goal2, wallet: wallet0, category: category3, title: 'Electronics Accessories', description: 'Bought accessories for electronics', amount: 50, date: Date.new(2024, 9, 9), transaction_type: 1)
...
transaction7 = Transaction.create(goal: goal1, wallet: wallet1, category: category1, title: 'Groceries', description: 'Bought weekly groceries', amount: 2076, date: Date.new(2024, 03, 10), transaction_type: 1)
